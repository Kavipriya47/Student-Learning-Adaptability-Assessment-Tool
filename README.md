# Student Learning Adaptability Assessment (SLAA) Tool
...
*   **Cloud**: Cloudinary (Image Orchestration), Render (Automated CI/CD), Resend (Transactional Emails).
...
4.  Enter your `MONGODB_URI`, `JWT_SECRET`, `RESEND_API_KEY`, and `CLOUDINARY` credentials.

**Render will automatically:**
*   Spin up your `slaa-api` (Node/Express).
*   Spin up your `slaa-web` (React Static Site).
*   Connect the internal URLs for a seamless handshake.
